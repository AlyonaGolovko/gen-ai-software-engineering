...
flowchart TD
    ...
    style U fill:#cfe9c5,stroke:#5a8a4e,stroke-width:2px,color:#5e5858
    style I fill:#dde9c5,stroke:#7a8a4e,stroke-width:2px,color:#5e5858
    style E fill:#e9d8c5,stroke:#8a6a4e,stroke-width:2px,color:#5e5858
    style P fill:#e9c5cd,stroke:#8a4e5a,stroke-width:2px,color:#5e5858
```
...
If you ever need to opt _out_ of the cleanup for a specific test (rare), the only safe way is to re-seed the data inside that test rather than disable the global hook.
